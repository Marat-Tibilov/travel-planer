        ...
        return (
            <div className="mt-6 px-4">
                ...
                <div className="flex space-x-4 pl-4">
                    {[...Array(5)].map((_, i) => (
                        <div key={i} className="min-w-[calc(80vw-20px)] sm:min-w-[200px] bg-gray-100 rounded-lg animate-pulse h-[180px]">
    ...
    return (
        <div className="mt-6 px-4">
            ...
            <div className="relative">
                ...
                >
                    {cities.map((city) => (
                        <SwiperSlide key={city.title} className="!w-[calc(80vw-20px)] sm:!w-[200px]">
                            <CityCard
                                city={city.title}
                                img={city.img}
